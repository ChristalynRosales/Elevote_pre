<?php
require_once 'userPanelRenderer.php'; // Include the UserPanelRenderer class
//$user 
$userPanel = new UserPanelRenderer($user);
?>
...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="voters.php"><i class="fa fa-user"></i> <span>Admin</span></a></li>
    </ul>
  </section>
  <!-- /.sidebar -->
</aside>
